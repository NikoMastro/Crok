...
ActiveRecord::Schema[7.1].define(version: 2024_08_19_064008) do
  ...
  create_table "heights", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dog_id"], name: "index_heights_on_dog_id"
  end
